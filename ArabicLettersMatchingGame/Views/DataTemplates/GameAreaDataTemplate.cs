...
public abstract class GameAreaDataTemplate(ReactiveCommand<int, Unit> buttonCommand)
{
    ...
    public abstract List<Button> Buttons { get; init; }
    ...
    protected static Button CreateButton(string marginThickness, int fontSize)
    {
        return new Button()
        {
            HorizontalAlignment = HorizontalAlignment.Stretch,
